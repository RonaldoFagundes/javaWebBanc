...
<%@page import="model.BancDataBeans"%>

<%
@ SuppressWarnings("unchecked")
ArrayList<BancDataBeans> list = (ArrayList<BancDataBeans>) request.getAttribute("dados");
%>
	...
	<table class="tbl-cad">
      ...
      <tbody>
         <%for (int i = 0; i < list.size(); i++) {%>
        	<tr>
			  <td><%=list.get(i).getHoje()%></td>
			  <td><%=list.get(i).getTipo()%></td>
			  <td><%=list.get(i).getCod()%></td>
			  <td><%=list.get(i).getValor()%></td>
			</tr>
			   <%}%>
	   </tbody>
	</table>
