...
<body onload="showBtnMov()" >
 ...
 <main class="main">
    ...
    <header class="header">  
         ...
         <div class="sidenav">          
             <h3><%out.println(user);%></h3>	      
             <button class="dropdown-btn">Menu
               <i class="fa fa-caret-down"></i>
             </button>              
            <div class="dropdown-container">            
             <div class="btn-movi-hidden" id="btn_movi" >
              <a href="mov">Movimentação</a>
             </div>              
 ...
 <div id="modal_container" class="container-modal" >
      
 <div class="content first-content">  
  <div class="first-column">	  
	    <h2 class="title title-primary">Seja Bem vindo(a)!</h2>		  
		<p class="description description-primary">Conheça todas as nossas</p>
		<p class="description description-primary">novidades</p>		  
  ...
  <div class="second-column">        
        ...
        <div class="social-media">           
         ...
         <a class="description description-second" href="">ou use seu email para se registrar</a>
          ...
          <form name="form_cad"  class="form cad"  action="cadastrar">
             ...
             <label class="label-input" for="">
		        ...
		        <input type="password"   name="password" placeholder="Password">
                 ...
                 <input type="button"  value="Cadastrar" id="btn-cad" onclick="validar()">                
          </form>          
  </div>  <!--fim second column    btn btn-second-->       
 ...
 <div class="content second-content"> 
    ...
    <form  name="frmLogin" action="logar" class="form login" >
		<label class="label-input" for="">
		  <i class="far fa-envelope icon-modify"></i> 		    
		...
		<button 	  
		  type="submit"  id="btn_logar" class="btn btn-second">Logar
	    </button> 	
	</form>          
